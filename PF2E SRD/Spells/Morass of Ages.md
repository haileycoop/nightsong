...
**Critical Failure** As failure, plus the creature also becomes [[Restrained]]. The creature can attempt to [[content/PF2E SRD/Actions/Escape]] against your spell DC to remove the restrained condition.
