...
abilities_bot:
  ...
  - name: "Ranged Strike"
    desc: "⬻ ([[range|range increment 60 feet]], [[reload|reload 1]]);  Damage 1d6 (1d6) piercing"
  - name: "Quick Draw"
    desc: "⬻  The drow sneak draws a weapon using the [[Interact]] action, then Strikes with that weapon."
  - name: "Sneak Attack"
    desc: "  The drow sneak deals an extra 1d6 (1d6) damage to creatures that have the [[flat-footed]] condition."
ac: 19
armorclass:
  - name: AC
