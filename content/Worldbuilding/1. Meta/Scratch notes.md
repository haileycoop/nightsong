...
- way to create a worldbuilding portal
	- use templater to create a warning at the top of every page to tell players they shouldn't be there
	- or maybe do this with styling in quartz?
- best way to maintain random tables
- best way to handle interactive maps

### Colville: dramatise your lore!
Just a really good video he did on how players don't care about lore if you don't dramatise it in the game

### ideas to build out the Maw

Hex ideas / rumours in town
...
- Echoes attacking the mining camp

Factions / People
- Eldergrove - might encounter a ranger early
- Harmony council
- The Escape
- The bandits that have a secret passage into the maw
- Dragon cult (Kobolds)
- Monster hunter cult? Monster tamers? Actually live in the Maw
- The hermit

Prep
- Create a palette of monsters that are in or out
- Create lots of random gen tables for encounters and locations
- Use existing tables to generate my locations, but edit them to fit with my desired flavour
- Start noting down my themes and vibes around the world and the Maw so I know how to filter

Other ideas
- Echos - undead that Ondra creates - even if you kill it, the Ondra has recorded the spirit, and keeps re-constructing it based on the original person
	- Related to the idea that Ondra reflects your being as a way to fight you

### what's outside the Maw

In the green area south of the jagged wastelands, I imagine that's where there is some level of civilisation. But because Ondra is so vicious, it's a patchwork of lesser kingdoms and city states. There is much unclaimed wild territory even there.

### image prompts for AI

a view of the midnight sky in a fantasy world. a cloudless sky, very dark. only starlight. the stars are a little fuzzy. In the center of the sky, looming above the horizon is a dark gas giant planet, similar to jupiiter, mostly black with streaks of red. the black is so dark it seems to absorb light. the horizon has mountains and rainforests. the style is modern comic book style

a landscape at midnight. it is very dark.the sky is clear. there are fuzzy stars providing starlight. there is a single  gas giant planet in the center of the sky. it is streaked like jupiter, but it is mostly black, with streaks of red. the landscape includes mountains and forests
